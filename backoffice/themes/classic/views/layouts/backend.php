         ...
         <!--<div class="p-2 align-self-center">
		       ...
		       <div class="dropdown ">	      
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
				    ...
				    <a class="dropdown-item" href="#">Single Merchant</a>			    
	      ...
	      <div class="d-flex flex-row">
	       ...
	       <div class="p-2 mr-4">
	           ...
	           <div class="dropdown userprofile">	      
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
				    <a class="dropdown-item" href="<?php echo Yii::app()->createUrl("/admin/profile");?>">Profile</a>
		   ...
		   <div id="vue-notifications" class="p-2 mr-4">
