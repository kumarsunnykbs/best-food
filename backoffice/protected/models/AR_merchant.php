	...
	protected function afterSave()
	{
		...
		switch ($this->scenario) {
			case "website_registration":			
				ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/aftermerchantsignup?".http_build_query($get_params) );			
				break;		
				
			case "after_payment_validate":				
			    ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/aftermerchantpayment?".http_build_query($get_params) );			
				break;		
				
			case "trial_will_end":	
			    $get_params['trial_end'] = $this->trial_end;
			    ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/merchant_trial_end?".http_build_query($get_params) );							
			    break;		
			    
		    case "plan_past_due":				
			    ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/after_plan_past_due?".http_build_query($get_params) );			
				break;			
