...
{	
    ...
    protected function beforeSave()
	{
		if(parent::beforeSave()){
			...
			/*if(is_array($this->cuisine_name_translation) && count($this->cuisine_name_translation)){
				$this->cuisine_name_trans = json_encode($this->cuisine_name_translation);				
			} else {
				$this->cuisine_name_trans='';
			}*/
