...
{	
	...
	protected function afterSave()
	{
		...
		switch ($this->scenario) {
			case "payout":
				ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/after_request_payout?".http_build_query($get_params) );
				break;
			case "payout_paid":		
			      ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/afterpayout_paid?".http_build_query($get_params) );
				break;					
				
			case "payout_cancel":				
			      ERunActions::touchUrl( CommonUtility::getHomebaseUrl()."/task/afterpayout_cancel?".http_build_query($get_params) );
				break;						
		}
	}
