...
class AttributesTools
{
	...
	public static function DateFormat()
	{
		...
		return array(
		  'EEEE, MMMM d, y'=>Date_Formatter::date(date('c'),'EEEE, MMMM d, y'),		  	
		  'EEE, MMMM d, y'=>Date_Formatter::date(date('c'),'EEE, MMMM d, y'),	
		  'EEE, MMM d, y'=>Date_Formatter::date(date('c'),'EEE, MMM d, y'),	
		  'MMMM EEEE d, y'=>Date_Formatter::date(date('c'),'MMMM EEEE d, y'),		  	
		  'MMMM EEE d, y'=>Date_Formatter::date(date('c'),'MMMM EEE d, y'),		  	
		  'MMM EEE d, y'=>Date_Formatter::date(date('c'),'MMM EEE d, y'),		  	
		  
		  'MMM d, y'=>Date_Formatter::date(date('c'),'MMM d, y'),
		  'M/d/yy'=>Date_Formatter::date(date('c'),'M/d/yy'),
		  'dd/MMM/yyyy'=>Date_Formatter::date(date('c'),'dd/MMM/yyyy'),	
		  'yyyy MMM dd'=>Date_Formatter::date(date('c'),'yyyy MMM dd'),		  
		);
	}
	...
	public static function CategoryResponsiveSettings($size="full")
	{
		...
		if($size=="half"){
			...
			$responsive_data[1000] = array('items'=>4,'nav'=>true,'loop'=>false);
