...
class MMenu extends CComponent
{
	...
	public static function getMenu($parent_id=0, $menu_type='')
	{
	 ...
	 public static function buildMenu($parent_id=0,$with_visible=false,$menu_type='admin')
	 {	 	 
	 	  $criteria=new CDbCriteria();
	 	  
	 	  $criteria->alias="a";
	 	  $criteria->condition="a.menu_type=:menu_type AND a.status=:status AND a.parent_id=:parent_id";
