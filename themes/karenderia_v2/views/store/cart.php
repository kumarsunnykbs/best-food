...
<div id="vue-cart" class="sticky-cart" >
  ...
  <div id="skeleton-loader" class="row m-0 " :class="{ loading: cart_loading }"  > 
       <div class="col-md-12 col-sm-3 p-0 position-relative mb-2" style="height:170px;">
  ...
  <template v-if="cart_loading==false">
    ...
    <div class="cart-empty text-center" >
      <div class="mt-5">
        ...
        <h6 class="m-0 mt-3">You don't have any orders here!</h6>
  ...
  <?php else :?>    
   <template v-if="cart_items.length>0">      
	  ...
	  >
	  <div class="flex-col">Checkout</div>
