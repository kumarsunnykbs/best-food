...
<div class="row no-gutters" v-if="merchant_info" >
  <div class="col-md-3 pt-4 pb-4 pr-2">
    ...
    <div class="mt-3 mb-3" >
        <h6>HOWS WAS YOUR ORDER?</h6>
        <p>let us know how your delivery wen and how you liked your order!</p>
        <div class="d-flex justify-content-end">
          <div><a @click="writeReview(order_uuid)" class="btn link text-green">Rate Your Order</a></div>
        </div>
    </div> <!--review-->     
    <div  class="divider p-0 mt-2 mb-2"></div>
    </template>
    ...
    <div class="mt-3 mb-3" >
     ...
     <p class="m-0 mb-1 bold">Order #{{order_info.order_id}}</p>
     <p class="m-0 mb-1 bold">{{items_count}} items</p>
     <p class="m-0 mb-1">{{order_info.sub_total}} Subtotal</p>
  ...
  <div class="col-md-9 page-grey p-0">
