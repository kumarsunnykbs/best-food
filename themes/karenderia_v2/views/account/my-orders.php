...
<div class="row mb-4">
  <div class="col d-flex justify-content-start align-items-center"> 
   <!--<h6 class="m-0 p-2 pd-5 with-icon-orders with-icon"><?php echo t("Orders")?></h6>-->
  </div> <!--col-->
...
<template v-if="!loading">
	...
	<div class="d-flex justify-content-center mt-4 mb-5" v-if="show_next_page" >
	 <a href="javascript:;" @click="loadMoreOrders(page)" class="btn btn-black m-auto w25">
...
<template v-if="load_more">
<div class="loading  mt-4 mb-5">
 <div class="m-auto circle-loader" data-loader="circle-side"></div>
</div>
</template>
...
<div class="order-details-panel section-cart" :class="{ open: show_details }" v-cloak >
   ...
   <div v-if="hasRefund" class="mt-3">
	   ...
	   <div v-for="item_refund in refund_transaction" class="p-2 rounded bg-light font11">
	     <div class="d-flex justify-content-between align-items-center">
	       <div class="flex-col">
	         <p class="m-0"><b>Description:</b> {{item_refund.description}}</p>
	         <p class="m-0"><b>Amount:</b> {{item_refund.trans_amount}}</p>
	         <p v-if="item_refund.used_card" class="m-0"><b>Issued to:</b> {{item_refund.used_card}}</p>
	         <p v-else class="m-0"><b>Issued to:</b> {{item_refund.payment_code}}</p>
	         <p class="m-0"><b>Date issued:</b> {{item_refund.date}}</p>
	       </div>
   ...
   <div v-cloak class="items" v-for="(items, index) in order_items" >
     ...
     <div class="line-items row mb-1">
       ...
       <div class="col-md-6 p-0 d-flex justify-content-start flex-column">
         <p class="mb-1">
         {{items.qty}}x
         {{ items.item_name }}
       ...
       <div class="col-md-3  quantity d-flex justify-content-start flex-column  text-right">
       <template v-if="items.price.discount<=0 ">
    ...
    <div class="addon-items row mb-1"  v-for="(addons, index_addon) in items.addons" >
      <div class="col-md-3 "><!--empty--></div> <!--col-->		     
      <div class="col-md-9 pl-0 d-flex justify-content-start flex-column ">
